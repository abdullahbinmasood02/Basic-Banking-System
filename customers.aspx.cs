...
{
    public string conString = "workstation id=bankdata.mssql.somee.com;packet size=4096;user id=abdullah02_SQLLogin_1;pwd=3ch1doqley;data source=bankdata.mssql.somee.com;persist security info=False;initial catalog=bankdata";
